...
*Load Archaiforge Core Kernel (01) and CLEAR AI Core (03) before using this extension. For architecture reviews, also load the Architecture extension. For security-sensitive code, load Security extension.*
