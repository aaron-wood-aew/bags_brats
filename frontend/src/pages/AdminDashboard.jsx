                        ...
                        <div className="glass-card" style={{ padding: '32px' }}>
                            ...
                            {!activeTournament ? (
                                ...
                                <div>
                                    ...
                                    {(() => {
                                        const isCheckInOpen = activeTournament.check_in_currently_open;
                                            ...
                                            <button
                                                onClick={async () => {
                                                    ...
                                                    try {
                                                        ...
                                                        showToast(err.response?.data?.error || 'Failed to open check-in early', 'error');
                                                    }
                                                }}
                                                ...
                                                style={{
                                                    ...
                                                    justifyContent: 'center',
                                                    gap: '8px',
                                                    background: isCheckInOpen ? 'rgba(16, 185, 129, 0.05)' : 'rgba(251, 191, 36, 0.1)',
                                                    border: isCheckInOpen ? '1px solid rgba(16, 185, 129, 0.4)' : '1px solid #fbbf24',
                                                    color: isCheckInOpen ? 'rgba(16, 185, 129, 0.6)' : '#fbbf24',
                                                    cursor: isCheckInOpen ? 'default' : 'pointer',
                                                    opacity: isCheckInOpen ? 0.7 : 1
                                                }}
                                            >
                                                {isCheckInOpen ? '🔓 Check-In Open' : '⏰ Open Check-In Early'}
                                            </button>
                                        );
                                    })()}
